<?php
$id=$_GET['id'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_alatkesehatan WHERE id='$id'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Update Data Alat Kesehatan</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="nama_alat" class="col-sm-3 control-label">Nama Alat</label>
                            <div class="col-sm-9">
                                <input type="text" name="nama_alat" value="<?=$data['nama_alat']?>"class="form-control" id="inputEmail3" placeholder="nama_alat">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success">
                                    <span class="fa fa-edit"></span> Update Data alat kesehatan</button>
                            </div>
                        </div>
                    </form>
                ...
                <div class="panel-footer">
                    <a href="?page=alatkesehatan&actions=tampil" class="btn btn-danger btn-sm">
                        Kembali Ke Data Alat Kesehatan
                    </a>
                </div>
            </div>
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE tbl_alatkesehatan SET id = '$id', nama_alat='$nama_alat', harga='$harga', stok_alat='$stok_alat' WHERE id='$id'"; 
